...
coefficients <- data.frame(
  ...
  Estimate = c(-2.02, 2.33, 0.17, -0.03, -0.37, -0.08, -0.68, -0.64),
  Est_Error = c(0.35, 0.12, 0.10, 0.08, 0.36, 0.24, 0.43, 0.23),
  `l-95% CI` = c(-2.71, 2.10, -0.02, -0.18, -1.08, -0.53, -1.54, -1.09),
  `u-95% CI` = c(-1.35, 2.56, 0.36, 0.12, 0.32, 0.40, 0.11, -0.19),
  Rhat = c(1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00),
  Bulk_ESS = c(664, 4872, 5407, 5999, 3861, 2898, 4024, 2812),
  Tail_ESS = c(1207, 3977, 3869, 3690, 3882, 3507, 3275, 3497)
)
